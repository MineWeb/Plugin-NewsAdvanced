  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-body">
          <form action="<?= $this->Html->url(array('controller' => 'NewsAdvanced', 'action' => 'add_ajax')) ?>" method="post" data-ajax="true" data-redirect-url="<?= $this->Html->url(array('controller' => 'NewsAdvanced', 'action' => 'admin_index', 'admin' => 'true')) ?>">
            ...
            <div class="form-group">
              ...
              <input name="img" class="form-control" placeholder="Miniature" type="text">
            </div>
